    ...
    def save_image(self, rsp_data, word):
        ...
        for image_info in rsp_data['imgs']:
            ...
            try:
                ...
                print("已有" + str(self.__counter) + "图")
                self.__counter += 1
        return

    # 开始获取
    def get_images(self, word='铃兰'):
...
if __name__ == '__main__':
    ...
    # crawler.start('', 10, 2)  # 抓取关键词为 “”，总数为 1 页（即总共 1*60=60 张），开始页码为 2
    crawler.start('铃兰', 10, 1)  # 抓取关键词为 “”，总数为 10 页（即总共 10*60=600 张），起始抓取的页码为 1
    # crawler.start('', 5)  # 抓取关键词为 “”，总数为 5 页（即总共 5*60=300 张）
